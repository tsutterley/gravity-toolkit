...
UPDATE HISTORY:
    ...
    Forked 01/2020 from plot_AIS_grid_3maps.py
...
def plot_grid(base_dir, FILENAMES,
    ...
    cbar.ax.set_title(CBTITLE, fontsize=14, rotation=0, y=-1.65, va='top')
    cbar.ax.set_xlabel(CBUNITS, fontsize=14, rotation=0, va='center')
    cbar.ax.xaxis.set_label_coords(1.08, 0.5)
