...
u"""
gen_harmonics.py
Finds the spherical harmonic coefficients of data
This is different than the gen_stokes.py function as it does not compute the
    solid earth elastic terms used in GRACE analyses
