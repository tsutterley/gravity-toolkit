...
def gen_point_load(data, lon, lat, UNITS=1, LMAX=60, MMAX=None, LOVE=None):
    ...
    for l in range(LMAX+1):
        m1 = np.min([l,MMAX]) + 1
        SPH = spherical_harmonic_matrix(l,D,theta,phi,dfactor[l])
...
def spherical_harmonic_matrix(l,data,theta,phi,coeff):
