...
We welcome and invite contributions from anyone at any career stage and with any amount of coding experience towards the development of ``read-GRACE-harmonics``.
...
2) Submitting bug reports or feature requests through the use of `GitHub issues <https://github.com/tsutterley/read-GRACE-harmonics/issues>`_
...
--------------------
Check the `project issues tab <https://github.com/tsutterley/read-GRACE-harmonics/issues>`_ to see if the feature has already been suggested.
...
Let us know if this is something you would like to contribute to ``read-GRACE-harmonics`` in your description as well.

Reporting a Bug
---------------
Check the `project issues tab <https://github.com/tsutterley/read-GRACE-harmonics/issues>`_ to see if the problem has already been reported.
...
- Bug fixes should be their own pull requests with an associated `GitHub issue <https://github.com/tsutterley/read-GRACE-harmonics/issues>`_
...
1) Fork the repository to your personal GitHub account by clicking the "Fork" button on the project `main page <https://github.com/tsutterley/read-GRACE-harmonics>`_.  This creates your own server-side copy of the repository.
...
5) Make your changes on the new branch and add yourself to the list of project `contributors <https://github.com/tsutterley/read-GRACE-harmonics/blob/main/CONTRIBUTORS.rst>`_.
6) Push your work to GitHub under your fork of the project.
7) Submit a `Pull Request <https://github.com/tsutterley/read-GRACE-harmonics/pulls>`_ from your forked branch to the project repository.
