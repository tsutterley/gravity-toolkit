#!/usr/bin/env python
u"""
plot_ASE_grid_maps.py
Written by Tyler Sutterley (03/2023)
Creates GMT-like plots for the Amundsen Sea Sector
...
def plot_grid(base_dir, FILENAME,
    ...
    fig,ax1 = plt.subplots(num=1, nrows=1, ncols=1, figsize=(10,9.5),
...
def arguments():
    parser = argparse.ArgumentParser(
        description="""Creates GMT-like plots of the Amundsen Sea Embayment
