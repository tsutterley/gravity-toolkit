...
def combine_HEX_mascon_timeseries(LMAX, RAD,
    MMAX=None,
    DESTRIPE=False,
    ...
    for i in region:
        ...
        for t in range(n_mon):
            ...
            print(f'{mon[t]:03d} {tdec[t]:12.4f} {mass_anomaly:14.6f}', file=fid1)
            print(f'{mon[t]:03d} {tdec[t]:12.4f} {thick_anomaly:14.6f}', file=fid2)
            print(f'{mon[t]:03d} {tdec[t]:12.4f} {mbar_anomaly:14.6f}', file=fid3)
