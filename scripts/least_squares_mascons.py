...
CALLING SEQUENCE:
    python least_squares_mascons.py

    Can use input parameter files to run an analysis:
    python least_squares_mascons.py mascon_parameter_file

    Can also input several parameter files in series:
    python least_squares_mascons.py parameter_file1 parameter_file2

    Can be run in parallel with the python multiprocessing package:
    python least_squares_mascons.py --np=2 parameter_file1 parameter_file2
    python least_squares_mascons.py -P 2 parameter_file1 parameter_file2

    Can output a log file listing the input parameters and output files:
    python least_squares_mascons.py --log parameter_file
    python least_squares_mascons.py -l parameter_file

SYSTEM ARGUMENTS README:
    program is run as:
    python least_squares_mascons.py inp1 inp2 inp3
    ...
    As python is base 0, sys.argv[0] is equal to least_squares_mascons.py
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="""Calculates regional mass anomalies through a
            least-squares mascon procedure procedure from an index
