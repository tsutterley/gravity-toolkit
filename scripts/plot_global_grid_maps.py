...
Creates global GMT-like plots in a Plate Carree (Equirectangular) projection
...
UPDATE HISTORY:
    ...
    Updated 08/2017: generalizations for different grids.  added BOUNDARY parameter
        plot Antarctic grounded ice
