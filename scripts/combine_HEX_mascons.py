...
def combine_HEX_mascons(
    ...
    for i in region:
        ...
        for t in range(n_rows):
            if DATE:
                print(
                    f'{mon[t]:03d} {tdec[t]:12.4f} {total_mass[t]:14.6f}',
                    file=fid1,
                )
                print(
                    f'{mon[t]:03d} {tdec[t]:12.4f} {total_thick[t]:14.6f}',
                    file=fid2,
                )
                print(
                    f'{mon[t]:03d} {tdec[t]:12.4f} {total_mbar[t]:14.6f}',
                    file=fid3,
                )
            else:
