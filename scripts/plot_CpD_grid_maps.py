#!/usr/bin/env python
u"""
plot_CpD_grid_maps.py
Written by Tyler Sutterley (03/2023)
Creates GMT-like plots for basin CpD (Totten, Moscow and Frost Glaciers)
...
UPDATE HISTORY:
    ...
    Updated 09/2017: plot mosaic function and use shapefiles
...
# Totten/Moscow/Frost bounds
xlimits = np.array([1200000, 2650000])
ylimits = np.array([-1800000, 0])
...
def plot_grid(base_dir, FILENAME,
    ...
    f1,ax1 = plt.subplots(num=1, nrows=1, ncols=1, figsize=(9.5,10),
    ...
    cbar = plt.colorbar(im, ax=ax1, pad=0.025, extend=CBEXTEND,
        extendfrac=0.0375, shrink=0.985, aspect=22.5, drawedges=False)
    ...
    if DRAW_SCALE:
        add_plot_scale(ax1,1230e3,-1740e3,200e3,28420,False)
...
def arguments():
    parser = argparse.ArgumentParser(
        description="""Creates GMT-like plots of Totten/Moscow/Frost Glaciers
