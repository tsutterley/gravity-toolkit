...
def plot_SLR_azimuthal(base_dir, PROC, DREL, START_MON, END_MON, MISSING):
    ...
    ax1 = {}
    ax2 = {}
    f1, (ax1['C21'], ax1['S21']) = plt.subplots(
        num=1, nrows=2, sharex=True, figsize=(6, 4)
    )
    f2, (ax2['C21'], ax2['S21']) = plt.subplots(
        num=2, nrows=2, sharex=True, figsize=(6, 4)
    )
    plot_colors = [
        'mediumseagreen',
        '0.5',
    ...
    plot_ylabel = {
        'C21': r'C$\mathregular{_{21}}$',
        'S21': r'S$\mathregular{_{21}}$',
    }
